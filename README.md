...
```bash
sh PatricBrowserTools_Slurm.sh <span style="color:blue">-o GENOMES_SAVING_DIRECTORY</span> <span style="color:green">-i ADDRESS_TO_GENOME_ID_TEXT_FILE</span> <span style="color:blue">-f FILE_TYPE</span> [options]
```
### Required arguments:
