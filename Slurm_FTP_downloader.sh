...
if [ -z "$File_type" ] || [ -z "$genomes_saving_directory" ] || [ -z "$Address_to_genome_id_text_file" ]; then
...
echo "rwX_group_access: $rwX_group_access"
echo "memory: $memory"
echo "cpus: $cpus"
...
echo "genomes_saving_directory: $genomes_saving_directory"
